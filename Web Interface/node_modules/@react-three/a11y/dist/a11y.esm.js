...
var A11yDebuger = function A11yDebuger(_ref) {
  ...
  useEffect(function () {
    ...
    var superinterval = window.setInterval(function () {
      ...
      render(React__default.createElement(React__default.Fragment, null, elements), domStructureRef.current);
    }, 2000);
    return function () {
  ...
  useLayoutEffect(function () {
    return void render(React__default.createElement(React__default.Fragment, null, React__default.createElement("label", null, "Prefer dark mode", React__default.createElement("input", {
      type: "checkbox",
